...
namespace ASCOM.APS.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.APS.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.APS.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _APS from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("ce7cbfbf-70b4-48cf-af5d-e7236fdc6c5f")]
    [ProgId("ASCOM.APS.Dome")]
    [ServedClassName("ASCOM APS Dome Driver")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="APS"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "APS.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
